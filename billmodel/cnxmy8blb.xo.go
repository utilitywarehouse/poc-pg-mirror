...
// Exists determines if the Cnxmy8Blb exists in the database.
func (cb *Cnxmy8Blb) Exists() bool {
	return cb._exists
}

// Deleted provides information if the Cnxmy8Blb has been deleted from the database.
func (cb *Cnxmy8Blb) Deleted() bool {
	return cb._deleted
}

// Insert inserts the Cnxmy8Blb to the database.
func (cb *Cnxmy8Blb) Insert(db XODB) error {
	var err error
	...
	// sql query
	const sqlstr = `INSERT INTO equinox.cnxmy8_blb (` +
		`blb_data, blb_text` +
		`) VALUES (` +
		`$1, $2` +
		`) RETURNING blb_lrn`
...
// Update updates the Cnxmy8Blb in the database.
func (cb *Cnxmy8Blb) Update(db XODB) error {
	var err error
	...
	// sql query
	const sqlstr = `UPDATE equinox.cnxmy8_blb SET (` +
		`blb_data, blb_text` +
		`) = ( ` +
		`$1, $2` +
		`) WHERE blb_lrn = $3`
...
// Save saves the Cnxmy8Blb to the database.
func (cb *Cnxmy8Blb) Save(db XODB) error {
	if cb.Exists() {
		return cb.Update(db)
	}
...
// Upsert performs an upsert for Cnxmy8Blb.
//
// NOTE: PostgreSQL 9.5+ only
func (cb *Cnxmy8Blb) Upsert(db XODB) error {
	var err error
...
// Delete deletes the Cnxmy8Blb from the database.
func (cb *Cnxmy8Blb) Delete(db XODB) error {
	var err error
	...
	// sql query
	const sqlstr = `DELETE FROM equinox.cnxmy8_blb WHERE blb_lrn = $1`
